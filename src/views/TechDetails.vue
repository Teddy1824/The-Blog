<template>
  <div class="container">
    <div v-if="techs" class="row d-flex justify-content-center">
      <div class="container">
        <div class="card">
          ...
          <div class="card__body">
            <span class="tag tag-blue">{{ techs.category }}</span>
            <h1>{{ techs.title }}</h1>
            <h3>{{ techs.subtitle }}</h3>
            <p>
              {{ techs.desc }}
            </p>
          </div>
          ...
          <div class="make-button">
            ...
            >
              <button
                ...
                href="#!"
                color="danger"
                @click.prevent="deleteBlog(techs._id)"
              >
                Delete
              </button>
            </router-link>
...
export default {
  ...
  mounted() {
    fetch("https://the-anything-blog1.herokuapp.com/tech/" + this.id, {
      method: "GET",
      headers: {
  ...
  methods: {
    updateBlog() {
      ...
      fetch("https://the-anything-blog1.herokuapp.com/tech/" + this.id, {
        ...
        .then((json) => {
          this.techs = json;
          alert("Blog Updated!");
          this.$router.push({ name: "techblogs" });
          location.reload();
        })
        .catch((err) => {
          alert(err);
    ...
    deleteBlog(id) {
      ...
      let apiURL = `https://the-anything-blog1.herokuapp.com/tech/${id}`;
