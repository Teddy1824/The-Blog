<template>
  <div class="container">
    <div v-if="lifestyle" class="row d-flex justify-content-center">
      <div class="container">
        <div class="card">
          ...
          <div class="card__body">
            <span class="tag tag-blue">{{ lifestyle.category }}</span>
            <h1>{{ lifestyle.title }}</h1>
            <h3>{{ lifestyle.subtitle }}</h3>
            <p>
              {{ lifestyle.desc }}
            </p>
          </div>
          ...
          <div class="make-button">
            ...
            >
              <button
                ...
                href="#!"
                color="danger"
                @click.prevent="deleteBlog(lifestyle._id)"
              >
                Delete
              </button>
            </router-link>
    ...
    <div v-else>
      <p class="m-5">Loading lifestyle...</p>
...
export default {
  ...
  mounted() {
    fetch("https://the-anything-blog1.herokuapp.com/lifestyles/" + this.id, {
      method: "GET",
      headers: {
  ...
  methods: {
    updateBlog() {
      ...
      fetch("https://the-anything-blog1.herokuapp.com/lifestyles/" + this.id, {
        ...
        .then((json) => {
          this.lifestyle = json;
          alert("Blog Updated!");
          this.$router.push({ name: "lifestyleblogs" });
          location.reload();
        })
        .catch((err) => {
          alert(err);
    ...
    deleteBlog(id) {
      ...
      let apiURL = `https://the-anything-blog1.herokuapp.com/lifestyles/${id}`;
