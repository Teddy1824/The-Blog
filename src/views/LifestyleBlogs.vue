<template>
  ...
  <div class="container flex">
    <div v-if="lifestyles.length">
      <div
        v-for="lifestyle in filterlifestyles"
        :key="lifestyle._id"
    ...
    <div v-else>
      <p class="m-5 center">Loading lifestyles...</p>
...
export default {
  ...
  computed: {
    filterlifestyles() {
      return this.lifestyles.filter((lifestyle) => {
        return lifestyle.title.toLowerCase().match(this.search.toLowerCase());
      });
    },
  },
  ...
  methods: {
    ...
    createBlog() {
      ...
      fetch("https://the-anything-blog1.herokuapp.com/lifestyles/lifestyles", {
        method: "POST",
        body: JSON.stringify({
