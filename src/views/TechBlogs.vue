...
<div class="container">
        ...
        <div class="card">
    <div class="img-container" :style="{ background: `url(${techs.main_image})`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat'}"></div>
    <div class="card-content">
      <h1>{{ techs.title }}</h1>
      <h2>{{techs.subtitle}}</h2>
      <p class="excerpt">{{techs.desc}}</p>
      <p class="author"> <img
    ...
    <div v-else>
      <p class="m-5 center">Loading tech...</p>
...
export default {
  ...
  computed: {
    filtertech() {
      return this.tech.filter((techs) => {
        return techs.title.toLowerCase().match(this.search.toLowerCase());
      });
    },
  },
  ...
  methods: {
    ...
    createBlog() {
      ...
      fetch("https://the-anything-blog1.herokuapp.com/tech/technology", {
        method: "POST",
        body: JSON.stringify({
